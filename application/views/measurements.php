<style type="text/css">
                            ...
                            <h5 class="breadcrumbs-title mt-0 mb-0">
                                <?php if(!empty($job)){ ?>
                                    <span class="highlightedText">
                                        ...
                                        > <?php echo $job['title']; ?> (Measurements)
                                    </span>
                                <?php }else{ ?>
                                    <span class="highlightedText">Measurements</span>
                                <?php } ?>
                            </h5>
                    ...
                    <div class="section section-data-tables">
                        <div class="card">
                            <div class="card-content">
                                <p class="caption mb-0 p-0 col s12 m12 l12">
                                    <?php if(!empty($job)){ ?>
                                        This is the area where you can manage <span class="highlightedText">measurements</span> of your jobs at a site.
                                    <?php }else{ ?>
                                        This is the area where you can manage <span class="highlightedText">measurements</span>.
                                    <?php } ?>
                                </p>
                                <br style="clear: both;" />
                            </div>
                        ...
                        <div class="card">
                            <div class="card-content">
                                ...
                                <a class="btn waves-effect waves-light gradient-45deg-green-teal smallBtn right modal-trigger" href="#addMeasurement">
                                    ADD NEW
                                </a>
                                <?php if(empty($job)){ ?>
    ...
    <div id="addMeasurement" class="modal" style="width: 50%;">
        <div class="modal-content">
            <h5>New Measurement</h5>
            <form role="form" id="addMeasurements" method="post" action="<?php echo base_url(); ?>user/addMeasurements" enctype="multipart/form-data">
                <?php if(empty($job)){ ?>
                    <div class="row">
...
$(document).ready(function(){
    ...
    $(document).on('click', '.deleteButton', function(){
        ...
        swal({
          ...
          if (willDelete) {
            $.ajax({
              url: BASE_URL + 'user/deleteMeasurements/' + id,
              type: 'GET',
    ...
    ajax: {
        url: BASE_URL + 'user/measurementsAjax',
        type: 'POST',
        dataSrc: 'data',
        data: function ( d ) {
            return $.extend( {}, d, {
