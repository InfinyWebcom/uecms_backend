<style type="text/css">
                            ...
                            <h5 class="breadcrumbs-title mt-0 mb-0">
                                <?php if(!empty($job)){ ?>
                                    <span class="highlightedText">
                                        ...
                                        > <?php echo $job['title']; ?> (Contract Expenses)
                                    </span>
                                <?php }else{ ?>
                                    <span class="highlightedText">Contract Expenses</span>
                                <?php } ?>
                        ...
                        <div class="card">
                            <div class="card-content">
                                <p class="caption mb-0 p-0 col s12 m12 l12">
                                    <?php if(!empty($job)){ ?>
                                        This is the area where you can manage <span class="highlightedText">contract expenses</span> of your jobs at a site.
                                    <?php }else{ ?>
                                        This is the area where you can manage <span class="highlightedText">contract expenses</span>.
                                    <?php } ?>
                                </p>
                                <br style="clear: both;" />
                            </div>
    ...
    <div id="addExpenses" class="modal" style="width: 50%;">
        <div class="modal-content">
            <h5>New Contract Expenses</h5>
            <form role="form" id="addContractExpenses" method="post" action="<?php echo base_url(); ?>user/addContractExpenses" enctype="multipart/form-data">
                <?php if(empty($job)){ ?>
                    <div class="row">
...
$(document).ready(function(){
    ...
    var table = $('#scroll-vert-hor2').DataTable({
        ...
        ajax: {
            url: BASE_URL + 'user/contractExpensesAjax',
            type: 'POST',
            dataSrc: 'data',
            data: function ( d ) {
                return $.extend( {}, d, {
