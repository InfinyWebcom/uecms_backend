            ...
            <div class="container">
                <div id="login-page" class="row">
                    <div class="col s12 m6 l4 z-depth-4 card-panel border-radius-6 login-card bg-opacity-8">
                        <form class="forgotPassword" method="POST" action="<?php echo base_url(); ?>home/forgotPassword">
                            <div class="row">
                                <div class="input-field col s12">
                                    <h5 class="center-align">Universal Enterprises CMS</h5>
                                    <h6 style="font-size: 12px;" class="center-align">Enter your email below and check your inbox.</h6>
                                </div>
                            </div>
